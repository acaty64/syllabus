...
<script src="{{ url('js/vue.js') }}"></script>
                    ...
                    <div v-if="linea.data">
                        <div v-if="linea.data.tipo == 'tabla2'">
                            <table class="table-striped col-md-12">
                                <tbody>
                                    <tr v-for="row2 in linea.data.info">
                                        <td v-for="(value, key) in row2">@{{ value }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <template id='table2_row_tpl'>
        <!--span v-html='<td>row2.wtitulo</td><td>row2.info</td>' ></span--> 
        <td>row2.wtitulo</td><td>row2.info</td>
    </template>
    ...
    <script type="text/javascript">
        ...
        new Vue({
            ...
            computed: {
                vhtml: function () {
console.log('funcion vhtml');
                    this.html = '<p>xxxxxxx</p>'
                },
            },
